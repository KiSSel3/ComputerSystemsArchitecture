...
;і     Хранитель экрана (Screen Saver). Copyright (c) 1999 by HackMaster     і
;АДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДДЩ

LOCALS  @@                                      ; локальные метки начинаются с @@

        ACTIVATE  EQU   108                    ; время астивизации хранителя экрана
...
KB      PROC                                    ; обработчик прерываний от клавиатуры
        ...
        MOV       CS:FINISH, 1                  ; установка флага окончания работы
